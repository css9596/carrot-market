...
export default function Enter() {
    ...
    return (
        <div className="mt-16 px-4">
            <h3 className="text-3xl font-bold text-center">당근 마켓 클론코딩</h3>
            <div className="mt-16">
                ...
                <div className="mt-8">
                    ...
                    <div className="grid grid-cols-2 mt-2 gap-3">
                        ...
                        <button
                            className="flex justify-center items-center py-2 px-4 border  border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-500 hover:bg-gray-50"
                        >
                            <svg
                                className="w-5 h-5"
                                aria-hidden="true"
